...
describe('IntegrationConfigService', () => {
  ...
  it('getOdoo hace GET a /integration-config/odoo', () => {
    const mock: OdooConfigDto = { url: 'u', db: 'd', username: 'u', apiKey: '••••••••', helpdeskTeamId: 7, expirationsHelpdeskTeamId: 9, stageInProgressName: 'En curso', stageNotDoneName: 'No realizadas', stageDoneName: 'Hecho', updatedAt: null, updatedBy: null };
  ...
  it('patchOdoo hace PATCH a /integration-config/odoo', () => {
    const mock: OdooConfigDto = { url: 'nuevo', db: 'd', username: 'u', apiKey: '••••••••', helpdeskTeamId: 7, expirationsHelpdeskTeamId: 9, stageInProgressName: 'En curso', stageNotDoneName: 'No realizadas', stageDoneName: 'Hecho', updatedAt: null, updatedBy: 'a' };
